...
public class PointServiceImpl implements PointService {
    ...
    @Override
    public void charge(Long memberId, String orderId, long amount, LocalDateTime approvedAt) {
        // 회원의 포인트 정보 조회 ( 비관적 락 )
        ...
        // 포인트 충전 이력 저장
        PointHistory pointHistory = PointHistory.create(memberId, orderId, amount, approvedAt);
    ...
    public boolean existsByOrderId(String orderId) {
        return pointHistoryRepository.existsByOrderId(orderId);
    }
}
